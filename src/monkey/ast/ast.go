...
func (pe *PrefixExpression) String() string {
	...
	console.WriteString("(")
	console.WriteString(pe.Operator)
	console.WriteString(pe.Right.String())
	console.WriteString(")")
...
func (ie *InfixExpression) String() string {
	...
	console.WriteString("(")
	console.WriteString(ie.Left.String())
	console.WriteString(" " + ie.Operator + " ")
	console.WriteString(ie.Right.String())
	console.WriteString(")")
